      ...
      <div className="max-w-2xl mx-auto px-4 py-10 sm:py-12 pb-24 sm:pb-12">
        ...
        <div className="text-center mb-8 sm:mb-10 fade-in">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base">
            Enter the <span className="text-purple-500 font-medium">6-digit passcode</span> to access your file.
          </p>
        </div>
        ...
        {fileInfo && (
          <div className="space-y-4 fade-in">
            {/* File info */}
            <div className="bg-white dark:bg-white/3 border border-slate-200 dark:border-white/10 rounded-2xl p-5 transition-colors duration-300">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-indigo-100 dark:from-indigo-500/20 to-purple-100 dark:to-purple-500/20 border border-indigo-200 dark:border-indigo-500/20 flex items-center justify-center flex-shrink-0">
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-semibold rounded-2xl shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 transition-all duration-200 flex items-center justify-center gap-3 text-base"
            >
            ...
            <div className="hidden sm:block">
              <p className="text-center text-slate-400 dark:text-slate-600 text-xs mb-3">
              ...
              >
                <div className="flex items-center gap-3">
                  <CloudArrowDownIcon className="w-5 h-5 text-indigo-500 flex-shrink-0" />
                  <span className="text-slate-700 dark:text-slate-300 text-sm font-medium truncate">{fileInfo.filename}</span>
                  <CloudArrowDownIcon className="w-5 h-5 flex-shrink-0 ml-auto text-slate-400" />
                </div>
              </div>
              <div className="mt-3">
